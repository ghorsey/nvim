...
function M.format(opts)
  ...
  }, opts("nvim-lspconfig").format or {})) -- Added local Opts function from utils
end
...
function M.get_formatters(bufnr)
  ...
  -- Check if we have any null-ls formatters ofr the current filetype
